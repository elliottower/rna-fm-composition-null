...
\title{A Composition-Controlled Evaluation of Structural\\
Awareness in RNA Foundation Models}
...
its RNA type, sequence length, and druggability evidence. The target panel is
stored as \texttt{druggability\_benchmark\_v2.tsv} and was frozen before
evaluation.

\begin{table}[htbp]
\centering
\caption{Target panel. POS: druggable positive; NEG: non-druggable
...
16-target panel (\texttt{druggability\_benchmark\_v2.tsv}), and the
